...
Phase 12A defined the contracts. Phase 12B implements saved-data scalar analyses. Phase 12C implements the empirical trajectory artifact and UI contract. Phase 12D designs a small randomized intervention. A stochastic-process model is deferred until path-dependence diagnostics justify one.
